...
public class User {
    ...
    public User(String email, String roles, String password, String name, String firstname, String image, boolean is_verified) {
        this.email = email;
        this.roles = roles;
        this.password = password;
        this.name = name;
    ...
    public User(String email, String roles, String password, String name, String firstname, String reset_token, String image, boolean is_verified) {
        this.email = email;
        this.roles = roles;
        this.password = password;
        this.name = name;
