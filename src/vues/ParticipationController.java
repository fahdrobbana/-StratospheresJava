  ...
  public static void sendSMS(String from, String to, String body) {
    ...
    private void Pdf(ActionEvent event) {
        ...
        try {
            ...
            doc.add(new Paragraph("  "));
            Paragraph title = new Paragraph("Liste des Participations", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 16, BaseColor.BLACK));
            ...
            for (int i = 0; i < p.rowPartic(); i++) {
                ...
                String event_id = tablepartic.getColumns().get(4).getCellObservableValue(i).getValue().toString();
